...
export const TA_PACK: LanguagePack = {
    ...
    Strings: {
        ...
        "nav.fullscreen": "முழுத்திரை",
        "nav.close": "மூடு",

        "weigh.label.tare": "காலி எடை",
        "weigh.label.gross": "மொத்த எடை",
        "weigh.label.net": "நிகர எடை",
        "weigh.label.charge": "கட்டணம்",
        "weigh.label.vehicleNo": "வாகன எண்",
        "weigh.label.party": "வாடிக்கையாளர்",
        "weigh.label.material": "பொருள்",
        "weigh.label.transporter": "போக்குவரத்து",
        stable: "நிலையானது",
        ...
        "weigh.notPrintedYet": "இன்னும் அச்சிடப்படவில்லை",
        "weigh.save": "சேமி",
        "weigh.print": "அச்சிடு",
        ...
        "weigh.label.ticketDate": "டிக்கெட் தேதி",
        "weigh.label.challanNo": "சலான் எண்",
        ...
        "masters.action.deleteConfirmTitle": "மாஸ்டரை நீக்கு",
        ...
        "settings.pane.fields": "புலங்கள்",
        "settings.pane.lang": "மொழி",
        "settings.pane.printer": "பிரிண்டர் & டிக்கெட்",
        ...
        "settings.printers.defaultLabel": "இயல்புநிலை அச்சுப்பொறி",
        "settings.printers.defaultHint":
            "ஒவ்வொரு டிக்கெட்டும் அறிக்கையும் இயல்பாக இதில் அச்சிடப்படும். விண்டோஸின் இயல்புநிலை அச்சுப்பொறியில் தொடங்கும்; வேறு ஒன்றை, அல்லது PDF-ஆக அச்சிடலைத் தேர்ந்தெடுக்கலாம்.",
        "settings.printers.pdfOption": "PDF ஆக அச்சிடு",
        "settings.printers.osDefaultBadge": "இயல்புநிலை",
        ...
        "settings.weighingRules.showSeriesInReports.label": "அறிக்கைகளில் தொடர் (series) வரம்பைக் காட்டு",
        "settings.weighingRules.showSeriesInReports.note":
            "இயக்கத்தில்: அறிக்கைகளின் தேதி-வரம்பு வரிசையிலும் அறிக்கை-உருவாக்கியிலும் ஒரு \"தொடர்\" (Series) கீழிறங்கு பட்டி தெரியும் — ஒரு குறிப்பிட்ட \"எண்ணிக்கையை இப்போது மீட்டமை\" தலைமுறைக்கோ அல்லது அனைத்து தொடர்களுக்குமோ அறிக்கையை வரம்பிடலாம். அணைக்கப்பட்டால் (இயல்பு): அறிக்கைகள் எப்போதும் தற்போதைய தொடருக்கு மட்டுமே வரம்பிடப்படும், கீழிறங்கு பட்டி மறைந்திருக்கும்.",
        ...
        "reports.savedReportsEditPrefix": "சேமித்த அறிக்கையைத் திருத்து",
        "reports.savedReportsDeleteConfirmTitle": "சேமித்த அறிக்கையை நீக்கு",
        "reports.savedReportsDeleteConfirm": "நிரந்தரமாக நீக்கு",
        "reports.savedReportsPlaceholder": "தற்போதைய காட்சியை சேமி…",
        "reports.savedReportsLabel": "சேமித்த காட்சி",
        "reports.savedReportsPlaceholder2": "ஒரு சேமித்த காட்சியைத் தேர்ந்தெடு…",
        "reports.savedReportsDynamic": "மாறும் (சேமிக்கப்படவில்லை)",
        "reports.savedReportsNone": "இன்னும் சேமித்த காட்சிகள் இல்லை",
        "reports.presets.daily": "தினசரி",
        "reports.presets.weekly": "வாராந்திர",
        "reports.presets.monthly": "மாதாந்திர",
        "reports.presets.waiting": "இரண்டாவது எடைக்காக காத்திருக்கிறது",
        "reports.series.all": "எல்லா தொடர்களும்",
        "reports.counts.matchingSuffix": "பொருந்துகிறது",
        ...
        "reports.builder.editTitle": "அறிக்கையைத் திருத்து",
        ...
        "settings.fieldSchema.previewKey": "சாவி",
        ...
        "settings.languagePane.title": "மொழிகள்",
        "settings.languagePane.filterPlaceholder": "சாவிகளை வடிகட்டு…",
        "settings.languagePane.col.key": "சாவி",
        "settings.languagePane.col.english": "ஆங்கிலம்",
        "settings.languagePane.col.language": "மொழி",
        "settings.languagePane.addLanguage": "மொழி சேர்",
        "settings.languagePane.addCode": "குறியீடு (எ.கா. hi)",
        "settings.languagePane.addName": "பெயர்",
        "settings.languagePane.addIncomplete": "ஒரு பெயரை உள்ளிடவும்",
        "settings.languagePane.addDuplicate": "அந்த குறியீடு ஏற்கனவே உள்ளது",
        "settings.languagePane.addLabelsJson": "லேபிள்கள் JSON (விருப்பத்தேர்வு)",
        "settings.languagePane.addLabelsJsonHint":
            "மொழிபெயர்க்கப்பட்ட லேபிள்கள் ஏற்கனவே இருந்தால் { \"key\": \"value\" } வரைபடத்தை ஒட்டவும் — விடுபட்டவை இல்லை என்று குறிக்கப்பட்டு எளிதில் கண்டறியப்படும். முழு ஆங்கில நகலிலிருந்து தொடங்க காலியாக விடவும்.",
        "settings.languagePane.addLabelsJsonPlaceholder": "{ \"weigh.title\": \"...\" }",
        "settings.languagePane.addInvalidJson": "இது சரியான லேபிள்கள் JSON அல்ல",
        "settings.languagePane.empty": "அந்த வடிகட்டலுக்கு பொருந்தும் சாவிகள் இல்லை",
        "settings.languagePane.missing": "(இல்லை)",
        "settings.languagePane.statusAll": "அனைத்தும்",
        "settings.languagePane.statusEdited": "திருத்தப்பட்டவை",
        "settings.languagePane.statusMissing": "இல்லாதவை",
        "settings.languagePane.statusLabel": "புலப் பெயர்கள்",
        "settings.languagePane.statusFilterLabel": "மொழிபெயர்ப்பு நிலை வடிகட்டி",
        "settings.languagePane.fieldAll": "அனைத்து துறைகள்",
        "settings.languagePane.fieldFilterLabel": "துறை வாரியாக வடிகட்டு",
        "settings.languagePane.filterBarLabel": "நிலை மற்றும் துறை வாரியாக வடிகட்டு",
        "settings.languagePane.renameTitle": "மொழியை மறுபெயரிடு",
        "settings.languagePane.renameLabel": "மறுபெயரிடு",
        "settings.languagePane.renameIncomplete": "ஒரு பெயரை உள்ளிடவும்",
        "settings.languagePane.deleteLabel": "மொழியை நீக்கு",
        "settings.languagePane.deleteConfirmTitle": "மொழியை நீக்கு",
        "settings.languagePane.deleteConfirm": "நிரந்தரமாக நீக்கு",
        "settings.languagePane.deleteBuiltInHint": "உள்ளமை மொழிகளை நீக்க முடியாது",
        ...
        "settings.printTemplates.hint":
            "ஒரு HTML வார்ப்புருவை பதிவேற்றவும் அல்லது ஒட்டவும், அதன் காகித அளவையும் விளிம்பையும் அமைத்து, சேமிப்பதற்கு முன் முன்னோட்டமிடவும். ஒவ்வொரு டிக்கெட்டும் அறிக்கையும் இன்னும் மூன்று உள்ளமைந்த தளவமைப்புகளில் (A4, தெர்மல், டாட்-மேட்ரிக்ஸ்) ஒன்றின் மூலமே அச்சிடப்படுகிறது — இங்கே சேமிக்கப்பட்ட வார்ப்புரு இன்னும் அச்சு பணியால் பயன்படுத்தப்படவில்லை.",
        "settings.printTemplates.addButton": "வார்ப்புரு சேர்",
        "settings.printTemplates.empty": "இன்னும் வார்ப்புருக்கள் இல்லை — தொடங்க ஒன்றைச் சேர்க்கவும்.",
        "settings.printTemplates.table.name": "பெயர்",
        "settings.printTemplates.table.size": "அளவு",
        "settings.printTemplates.table.actions": "செயல்கள்",
        "settings.printTemplates.preview": "முன்னோட்டம்",
        "settings.printTemplates.edit": "திருத்து",
        "settings.printTemplates.delete": "நீக்கு",
        "settings.printTemplates.deleteTitle": "வார்ப்புருவை நீக்கு",
        "settings.printTemplates.deleteMessage": "வார்ப்புருவை நீக்கு",
        "settings.printTemplates.previewModalTitle": "முன்னோட்டம்",
        "settings.printTemplates.select": "தேர்ந்தெடு",
        "settings.printTemplates.selected": "தேர்ந்தெடுக்கப்பட்டது",
        "settings.printOptions.title": "அச்சு விருப்பத்தேர்வுகள்",
        "settings.printOptions.copies": "பிரதிகளின் எண்ணிக்கை",
        "settings.printOptions.showDialog": "அச்சிடும் முன் அச்சு உரையாடலைக் காட்டு",
        "settings.printTemplates.cantDeleteTitle": "வார்ப்புருவை நீக்க முடியாது",
        "settings.printTemplates.cantDeleteDefault": "இது ஒரு இயல்புநிலை வார்ப்புரு, நீக்க முடியாது.",
        "settings.printTemplates.cantDeleteSelected": "இந்த வார்ப்புரு தற்போது எடையிடல் அமர்வுக்குத் தேர்ந்தெடுக்கப்பட்டுள்ளது — நீக்குவதற்கு முன் வேறு ஒன்றைத் தேர்ந்தெடுக்கவும்.",
        "settings.printTemplates.cantDeleteOk": "சரி",
        "settings.printTemplates.wizard.addTitle": "அச்சு வார்ப்புரு சேர்",
        "settings.printTemplates.wizard.editTitle": "அச்சு வார்ப்புருவை திருத்து",
        "settings.printTemplates.wizard.dropPrompt": "ஒரு HTML வார்ப்புருவை இங்கே விடவும், அல்லது தேர்ந்தெடுக்க கிளிக் செய்யவும்",
        "settings.printTemplates.wizard.pasteInstead": "…அல்லது HTML-ஐ ஒட்டவும்",
        "settings.printTemplates.wizard.save": "சேமி",
        "settings.printTemplates.wizard.name": "பெயர்",
        "settings.printTemplates.wizard.width": "அகலம் (mm)",
        "settings.printTemplates.wizard.height": "உயரம் (mm)",
        "settings.printTemplates.wizard.margin": "விளிம்பு (mm)",
        "settings.printTemplates.wizard.previewTitle": "முன்னோட்டம்",
        ...
        "weigh.label.DriverMobile": "டிரைவர் மொபைல்",
        "weigh.label.NoOfBags": "பைகளின் எண்ணிக்கை",
        "weigh.label.BagWeight": "பை எடை",
        "weigh.label.FullBagWeight": "முழு பை எடை",
        "weigh.label.Adjust": "சரிசெய்",
        "weigh.label.NetAfterBags": "பைகளுக்குப் பின் நிகரம்",
        "weigh.label.EstimatedWeight": "மதிப்பிடப்பட்ட எடை",
        "weigh.label.ExcessShortage": "அதிகம்/குறைவு",
        "weigh.label.TotalAdjustment": "மொத்த சரிசெய்தல்",
        "weigh.label.GodownGross": "கோடவுன் மொத்த எடை",
        "weigh.label.GodownNet": "கோடவுன் நிகர எடை",
