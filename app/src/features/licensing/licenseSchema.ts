...
// is nonetheless quantized to whole days (PLAN §4.10 "trial with expiry"),
...
export const licenseBodySchema = z.object({
    ...
    /** The ~124-char base32 code from `licensegen sign` (tools/licensegen, task #37), or null before one's ever been pasted in. */
